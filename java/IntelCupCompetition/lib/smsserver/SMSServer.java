...
class SMSServer extends Thread
{
	...
	public String stripHtml(String s)
	{
		...
		o = org.smslib.CUtils.replace(s, "<html>", "");
		o = org.smslib.CUtils.replace(o, "</html>", "");
		o = org.smslib.CUtils.replace(o, "<b>", "");
		o = org.smslib.CUtils.replace(o, "</b>", "");
		o = org.smslib.CUtils.replace(o, "<h1>", "");
		o = org.smslib.CUtils.replace(o, "</h1>", "");
		o = org.smslib.CUtils.replace(o, "<br>", "");
		return o;
	}
